	...
	<body>
			...
			<div class="carousel-inner text-center">
				...
				<div class="item">
					...
					<div class="carousel-caption hidden-xs">
						<h1 class="text-light">Liste des candidats retenue</h1>
		...
		<section id="about" class="section about-section">
			...
			<div class="container text-center-xs">
				...
				<h6 class="text-center text-light text-grey-color"><em>Liste des candidats retenue</em></h6>
...
<div class="">
  ...
  <thead>
				...
				<th>Stage</th>
					...
					$sql = "select * FROM candidat where situation_candidat = 'Retenue'  ORDER BY id_candidat desc" ;
