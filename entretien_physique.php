...
INNER JOIN candidat ON candidat.id_candidat = entretien.id_candidat
 where entretien.type_entretien='Entretien Physique'";
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <p class="lead">Greatcall Entretien Physique</p>
      ...
      <div class="modal-footer">
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			...
			<form class="form-horizontal" method="POST" action="editEventTitle.php">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" name="telephone" class="form-control" id="telephone" placeholder="Title">
					</div>
				  </div>
          ...
          <input type="hidden" name="id_entretien" class="form-control" id="id_entretien" >
			  ...
			  <div class="modal-footer">
			  <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>        
				<button type="submit" class="btn btn-primary">Supprimé</button>
				<button type="submit" id="retenue" name="retenue" class="btn btn-success">Retenue</button>
	...
	<footer class="main-footer">
			...
			<div class="container text-center-xs">
				...
				<div class="row">
					...
					<div class="col-sm-4 col-xs-12">
						<p class="text-center">
							© Kglink All Rights Reserved | By yassine es sammah
						</p>
					</div>
