			...
			<div class="carousel-inner text-center">
				...
				<div class="item">
					...
					<div class="carousel-caption hidden-xs">
						<h1 class="text-light">Liste des abandons</h1>
...
<div class="">
  ...
  <thead>
					...
					<?php
								...
								$sql = "select * FROM candidat where situation_candidat in ('Il a abondonner la formation','Il a abondonner le stage','Il a abondonner le poste') " ;
    foreach  ($bdd->query($sql) as $row) {
			   ...
			   <td><?php echo $row['cin']; ?></td>
                ...
                <td><?php echo $row['niveau_etude']; ?></td>
							...
							<td><button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#myModal<?php echo $row['id_candidat']; ?>">Détail</button>
</td>
