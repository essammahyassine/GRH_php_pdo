...
<?php require_once('nav.php');?>
				...
				<div class="item">
					...
					<div class="carousel-caption hidden-xs">
						<h1 class="text-light">Formation</h1>
						 <h5 class="text-light">Greatcall call center</h5>
		...
		<section id="about" class="section about-section">
			...
			<div class="container text-center-xs">
				...
				<h6 class="text-center text-light text-grey-color"><em>Création d'une nouvelle formation</em></h6>
	...
	<form accept-charset="utf-8" method="post" enctype="multipart/form-data" id="UserProfileForm" class="form-horizontal"method="POST" action="f.php">
          



		  <div class="form-group">
		   <label for="usr">Formateur:</label>
		   <input type="text" class="form-control" placeholder="Formateur" id="formateur" name="formateur">
		 </div>
		 
		  <div class="form-group">
		   <label for="usr">Projet:</label>
		   <input type="text" class="form-control" placeholder="Projet" id="projet" name="projet">
		 </div>
