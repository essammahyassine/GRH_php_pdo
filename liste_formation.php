	...
	<body>
			...
			<div class="carousel-inner text-center">
				...
				<div class="item">
					...
					<div class="carousel-caption hidden-xs">
						<h1 class="text-light">Liste des Formations</h1>
		...
		<section id="about" class="section about-section">
			...
			<div class="container text-center-xs">
				...
				<h6 class="text-center text-light text-grey-color"><em>Liste des Formations</em></h6>
...
<div class="">
  ...
  <thead>
					  ...
					  <td>
					  <p style='color:#fff;'>Liste des candidats</p>
					  </td>
                     </tr>
					  </thead>
					                          <tbody>
					...
					$sql = "select * FROM formation ORDER BY formation.id_formation desc" ;
...
<td><a class="btn btn-danger btn-block" href="./affecterformation.php?id=<?php echo $row['id_formation']; ?>">Affecter</a></td>	
<td><a class="btn btn-primary btn-block" href="./formationcandidat.php?id=<?php echo $row['id_formation']; ?>">Candidat</a> </td>				
				</tr>
