...
<?php require_once('navuser.php');?>
			...
			<div class="carousel-inner text-center">
				...
				<div class="item">
					...
					<div class="carousel-caption hidden-xs">
						<h1 class="text-light">Demande de congé </h1>
    ...
    <form accept-charset="utf-8" method="post" enctype="multipart/form-data" id="UserProfileForm" class="form-horizontal"method="POST" action="dc.php">
          
          <div class="form-group">
   <label for="usr">Salarié:</label>
   <input type="text" class="form-control"  id="nom" name="nom" value="<?php echo $username;?>"	readonly>
  ...
  <div class="form-group">
   <label for="usr">Type congé:</label>
   <select id="type_conge" name="type_conge" class="form-control">
                       
                       <option value="Maternite" > Maternité </option>
                       <option value="Conge sans solde" > Congé sans solde </option>
 ...
 <br>	
 <div class="form-group">
   <label for="usr">Nombre jour:</label>
   <input type="text" class="form-control" placeholder="Nombre jour" id="nombre_jour" name="nombre_jour">
 </div>
