	...
	<body>
			...
			<div class="container text-center-xs">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-xs-12 text-grey-color">
						<strong class="text-spl-color">Greatcall</strong>
					</div>
			...
			<div class="carousel-inner text-center">
				...
				<div class="item">
					...
					<div class="carousel-caption hidden-xs">
						<h1 class="text-light">Liste des candidats non retenue</h1>
		...
		<section id="about" class="section about-section">
			...
			<div class="container text-center-xs">
				...
				<h6 class="text-center text-light text-grey-color"><em>Liste des candidats non retenue</em></h6>
...
<div class="">
  ...
  <thead>
                ...
                <th>Détail</th>
					...
					$sql = "select * FROM candidat where situation_candidat = 'Non Retenue'  ORDER BY id_candidat desc" ;
