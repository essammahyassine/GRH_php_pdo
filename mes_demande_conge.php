...
<div class="">
  ...
  <thead>
  <tr bgcolor="#337ab7">
                <th><p style='color:#fff;'>Type congé</p></th>
                <th><p style='color:#fff;'>Date debut</p></th>
                <th><p style='color:#fff;'>Nombre de jour</p></th>
                <th><p style='color:#fff;'>Status demande</p></th>
                <th><p style='color:#fff;'>Motif demande</p></th>
					...
					$sql = "select * FROM conge where id_candidat=".$userid ;
    foreach  ($bdd->query($sql) as $row) {
			   ...
			   <td><?php echo $row['type_conge']; ?></td>
                ...
                <td><?php echo $row['nombre_de_jour']; ?></td>
                <td><?php echo $row['statu_demande']; ?></td>
                <td><?php echo $row['motif_demande']; ?></td>
				</tr>
